...
public class MemberBean
{
	...
	{
		return "클래스명=[MemberBean] 필드명[userId=" + userId + ", userPw=" + userPw + ", userMail=" + userMail
				+ ", userName=" + userName + ", postalCode=" + postalCode + ", roadAddress=" + roadAddress
				+ ", branchAddress=" + branchAddress + ", subAddress=" + subAddress + ", jubun1=" + jubun1 + ", jubun2="
				+ jubun2 + ", hobby=" + hobby + ", intro=" + intro + "]";
	}
